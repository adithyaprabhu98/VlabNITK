...
mpl$lab$util$Util.COMPILE_TIME = "2019-05-12 11:36:04";
...
;
var mpl$sims$springs$DoubleSpringSim = function(a, b) {
    mpl$lab$model$AbstractODESim.call(this, b);
    this.setVarsList(new mpl$lab$model$VarsList([mpl$sims$springs$DoubleSpringSim.en.POSITION + "-1", mpl$sims$springs$DoubleSpringSim.en.POSITION + "-2", mpl$sims$springs$DoubleSpringSim.en.VELOCITY + "-1", mpl$sims$springs$DoubleSpringSim.en.VELOCITY + "-2", mpl$sims$springs$DoubleSpringSim.en.ACCELERATION + "-1", mpl$sims$springs$DoubleSpringSim.en.ACCELERATION + "-2", mpl$lab$model$EnergySystem.en.KINETIC_ENERGY, mpl$lab$model$EnergySystem.en.POTENTIAL_ENERGY, mpl$lab$model$EnergySystem.en.TOTAL_ENERGY, mpl$lab$model$VarsList.en.TIME],[mpl$sims$springs$DoubleSpringSim.i18n.POSITION + "-1", mpl$sims$springs$DoubleSpringSim.i18n.POSITION + "-2", mpl$sims$springs$DoubleSpringSim.i18n.VELOCITY + "-1", mpl$sims$springs$DoubleSpringSim.i18n.VELOCITY + "-2", mpl$sims$springs$DoubleSpringSim.i18n.ACCELERATION + "-1", mpl$sims$springs$DoubleSpringSim.i18n.ACCELERATION + "-2", mpl$lab$model$EnergySystem.i18n.KINETIC_ENERGY, mpl$lab$model$EnergySystem.i18n.POTENTIAL_ENERGY, mpl$lab$model$EnergySystem.i18n.TOTAL_ENERGY, mpl$lab$model$VarsList.i18n.TIME],this.getName() + "_VARS"));
    this.getVarsList().setComputed(4, 5, 6, 7, 8);
    this.block1_ = mpl$lab$model$PointMass.makeSquare(1, "block1");
    this.block2_ = mpl$lab$model$PointMass.makeSquare(1, "block2");
    this.wall1_ = mpl$lab$model$PointMass.makeRectangle(.4, 4, "wall1").setMass(mpl$lab$util$Util.POSITIVE_INFINITY);
    this.wall1_.setPosition(new mpl$lab$util$Vector(-.2,0));
    this.wall2_ = mpl$lab$model$PointMass.makeRectangle(.4, 4, "wall2").setMass(mpl$lab$util$Util.POSITIVE_INFINITY);
    this.wall2_.setPosition(new mpl$lab$util$Vector(9.8,0));
    this.stiffness_ = 6;
    this.thirdSpring_ = a;
    this.spring1_ = new mpl$lab$model$Spring("spring1",this.wall1_,new mpl$lab$util$Vector(this.wall1_.getWidth() / 2,0),this.block1_,mpl$lab$util$Vector.ORIGIN,3,this.stiffness_);
    this.spring2_ = new mpl$lab$model$Spring("spring2",this.block1_,mpl$lab$util$Vector.ORIGIN,this.block2_,mpl$lab$util$Vector.ORIGIN,3,this.stiffness_);
    this.spring3_ = new mpl$lab$model$Spring("spring3",this.block2_,mpl$lab$util$Vector.ORIGIN,this.wall2_,new mpl$lab$util$Vector(-this.wall2_.getWidth() / 2,0),3,this.thirdSpring_ ? this.stiffness_ : 0);
    ...
    this.getSimList().add(this.wall1_, this.wall2_, this.block1_, this.block2_, this.spring1_, this.spring2_, this.spring3_);
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$DoubleSpringSim.en.DAMPING,mpl$sims$springs$DoubleSpringSim.i18n.DAMPING,goog.bind(this.getDamping, this),goog.bind(this.setDamping, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$DoubleSpringSim.en.LENGTH,mpl$sims$springs$DoubleSpringSim.i18n.LENGTH,goog.bind(this.getLength, this),goog.bind(this.setLength, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$DoubleSpringSim.en.MASS1,mpl$sims$springs$DoubleSpringSim.i18n.MASS1,goog.bind(this.getMass1, this),goog.bind(this.setMass1, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$DoubleSpringSim.en.MASS2,mpl$sims$springs$DoubleSpringSim.i18n.MASS2,goog.bind(this.getMass2, this),goog.bind(this.setMass2, this)));
    this.addParameter(new mpl$lab$util$ParameterNumber(this,mpl$sims$springs$DoubleSpringSim.en.STIFFNESS,mpl$sims$springs$DoubleSpringSim.i18n.STIFFNESS,goog.bind(this.getStiffness, this),goog.bind(this.setStiffness, this)));
    this.addParameter(new mpl$lab$util$ParameterBoolean(this,mpl$sims$springs$DoubleSpringSim.en.THIRD_SPRING,mpl$sims$springs$DoubleSpringSim.i18n.THIRD_SPRING,goog.bind(this.getThirdSpring, this),goog.bind(this.setThirdSpring, this)))
};
$jscomp.inherits(mpl$sims$springs$DoubleSpringSim, mpl$lab$model$AbstractODESim);
mpl$sims$springs$DoubleSpringSim.prototype.toString = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : this.toStringShort().slice(0, -1) + ", block1_: " + this.block1_ + ", block2_: " + this.block2_ + ", spring1_: " + this.spring1_ + ", damping_: " + mpl$lab$util$Util.NF(this.damping_) + ", stiffness_: " + mpl$lab$util$Util.NF(this.stiffness_) + ", thirdSpring_: " + this.thirdSpring_ + mpl$lab$model$AbstractODESim.prototype.toString.call(this)
}
;
mpl$sims$springs$DoubleSpringSim.prototype.getClassName = function() {
    return "DoubleSpringSim"
}
;
mpl$sims$springs$DoubleSpringSim.prototype.restState = function() {
    var a = this.getVarsList().getValues()
      , b = this.spring1_.getStiffness()
      , c = this.spring2_.getStiffness()
      , d = this.spring3_.getStiffness()
      , e = this.spring1_.getRestLength()
      , f = this.spring2_.getRestLength()
      , g = this.spring3_.getRestLength()
      , h = this.wall1_.getBoundsWorld().getRight()
      , k = this.wall2_.getBoundsWorld().getLeft();
    d = (b * h + b * e + d * k + d * b / c * (h + e) - d * f - d * g) / (b + d * b / c + d);
    a[0] = d;
    a[1] = b / c * (d - h - e) + d + f;
    a[2] = a[3] = 0;
...
;
mpl$sims$springs$DoubleSpringSim.prototype.getEnergyInfo = function() {
    var a = this.getVarsList().getValues();
    this.moveObjects(a);
    return this.getEnergyInfo_(a)
}
;
mpl$sims$springs$DoubleSpringSim.prototype.getEnergyInfo_ = function(a) {
    a = this.block1_.getKineticEnergy() + this.block2_.getKineticEnergy();
    var b = this.potentialOffset_;
    goog.array.forEach(this.springs_, function(a) {
        b += a.getPotentialEnergy()
    });
    return new mpl$lab$model$EnergyInfo(b,a)
}
;
mpl$sims$springs$DoubleSpringSim.prototype.setPotentialEnergy = function(a) {
    this.potentialOffset_ = 0;
    this.potentialOffset_ = a - this.getEnergyInfo().getPotential()
}
;
mpl$sims$springs$DoubleSpringSim.prototype.modifyObjects = function() {
    ...
    b[4] = c[2];
    b[5] = c[3];
    c = this.getEnergyInfo_(b);
    b[6] = c.getTranslational();
    b[7] = c.getPotential();
    b[8] = c.getTotalEnergy();
    a.setValues(b, !0)
}
;
mpl$sims$springs$DoubleSpringSim.prototype.moveObjects = function(a) {
    this.block1_.setPosition(new mpl$lab$util$Vector(a[0],0));
    this.block1_.setVelocity(new mpl$lab$util$Vector(a[2],0,0));
    this.block2_.setPosition(new mpl$lab$util$Vector(a[1],0));
    this.block2_.setVelocity(new mpl$lab$util$Vector(a[3],0,0))
}
;
mpl$sims$springs$DoubleSpringSim.prototype.startDrag = function(a, b, c, d, e) {
    if (a == this.block1_)
        return this.dragBlock_ = 0,
        !0;
    if (a == this.block2_)
        return this.dragBlock_ = 1,
        !0;
    this.dragBlock_ = -1;
    return !1
}
;
mpl$sims$springs$DoubleSpringSim.prototype.mouseDrag = function(a, b, c, d) {
    b = b.subtract(c);
    0 <= this.dragBlock_ && 1 >= this.dragBlock_ && a == (0 == this.dragBlock_ ? this.block1_ : this.block2_) && (a = this.getVarsList(),
    a.setValue(this.dragBlock_, b.getX()),
    a.setValue(this.dragBlock_ + 2, 0),
    a.incrSequence(6, 7, 8),
    this.moveObjects(a.getValues()))
}
;
mpl$sims$springs$DoubleSpringSim.prototype.finishDrag = function(a, b, c) {
    this.dragBlock_ = -1
}
;
mpl$sims$springs$DoubleSpringSim.prototype.handleKeyEvent = function(a, b, c) {}
;
mpl$sims$springs$DoubleSpringSim.prototype.evaluate = function(a, b, c) {
    mpl$lab$util$Util.zeroArray(b);
    b[9] = 1;
    this.moveObjects(a);
    0 != this.dragBlock_ && (b[0] = a[2],
    b[2] = (-this.spring1_.getStiffness() * this.spring1_.getStretch() + this.spring2_.getStiffness() * this.spring2_.getStretch() - this.damping_ * a[2]) / this.block1_.getMass());
    1 != this.dragBlock_ && (b[1] = a[3],
    b[3] = (-this.spring2_.getStiffness() * this.spring2_.getStretch() + this.spring3_.getStiffness() * this.spring3_.getStretch() - this.damping_ * a[3]) / this.block2_.getMass());
    return null
}
;
mpl$sims$springs$DoubleSpringSim.prototype.getThirdSpring = function() {
    return this.thirdSpring_
}
;
mpl$sims$springs$DoubleSpringSim.prototype.setThirdSpring = function(a) {
    a != this.thirdSpring_ && (this.thirdSpring_ = a,
    this.spring3_.setStiffness(a ? this.stiffness_ : 0),
    this.getVarsList().incrSequence(6, 7, 8),
    this.broadcastParameter(mpl$sims$springs$DoubleSpringSim.en.THIRD_SPRING))
}
;
mpl$sims$springs$DoubleSpringSim.prototype.getMass1 = function() {
    return this.block1_.getMass()
}
;
mpl$sims$springs$DoubleSpringSim.prototype.setMass1 = function(a) {
    this.block1_.setMass(a);
    this.getVarsList().incrSequence(6, 7, 8);
    this.broadcastParameter(mpl$sims$springs$DoubleSpringSim.en.MASS1)
}
;
mpl$sims$springs$DoubleSpringSim.prototype.getMass2 = function() {
    return this.block2_.getMass()
}
;
mpl$sims$springs$DoubleSpringSim.prototype.setMass2 = function(a) {
    this.block2_.setMass(a);
    this.getVarsList().incrSequence(6, 7, 8);
    this.broadcastParameter(mpl$sims$springs$DoubleSpringSim.en.MASS2)
}
;
mpl$sims$springs$DoubleSpringSim.prototype.getLength = function() {
    return this.springs_[0].getRestLength()
}
;
mpl$sims$springs$DoubleSpringSim.prototype.setLength = function(a) {
    for (var b = 0; b < this.springs_.length; b++)
        this.springs_[b].setRestLength(a);
    this.getVarsList().incrSequence(7, 8);
    this.broadcastParameter(mpl$sims$springs$DoubleSpringSim.en.LENGTH)
}
;
mpl$sims$springs$DoubleSpringSim.prototype.getStiffness = function() {
    return this.stiffness_
}
;
mpl$sims$springs$DoubleSpringSim.prototype.setStiffness = function(a) {
    this.stiffness_ != a && (this.stiffness_ = a,
    this.spring1_.setStiffness(a),
    this.spring2_.setStiffness(a),
    this.thirdSpring_ && this.spring3_.setStiffness(a),
    this.getVarsList().incrSequence(7, 8),
    this.broadcastParameter(mpl$sims$springs$DoubleSpringSim.en.STIFFNESS))
}
;
mpl$sims$springs$DoubleSpringSim.prototype.getDamping = function() {
    return this.damping_
}
;
mpl$sims$springs$DoubleSpringSim.prototype.setDamping = function(a) {
    this.damping_ = a;
    this.broadcastParameter(mpl$sims$springs$DoubleSpringSim.en.DAMPING)
}
;
mpl$sims$springs$DoubleSpringSim.en = {
...
mpl$sims$springs$DoubleSpringSim.de_strings = {
...
mpl$sims$springs$DoubleSpringSim.i18n = "de" === goog.LOCALE ? mpl$sims$springs$DoubleSpringSim.de_strings : mpl$sims$springs$DoubleSpringSim.en;
...
;
var mpl$sims$springs$DoubleSpringApp = function(a) {
    mpl$lab$util$Util.setErrorHandler();
    var b = new mpl$lab$util$DoubleRect(-.5,-5,10,5)
      , c = new mpl$sims$springs$DoubleSpringSim(!1)
    ...
    this.wall1 = new mpl$lab$view$DisplayShape(this.simList.getPointMass("wall1"),this.protoWall);
    this.wall2 = new mpl$lab$view$DisplayShape(this.simList.getPointMass("wall2"),this.protoWall);
    ...
    this.spring3 = new mpl$lab$view$DisplaySpring(this.simList.getSpring("spring3"),this.protoSpring);
    ...
    a = c.getParameterNumber(mpl$sims$springs$DoubleSpringSim.en.MASS1);
    this.addControl(new mpl$lab$controls$SliderControl(a,.2,20.2,!0));
    a = c.getParameterNumber(mpl$sims$springs$DoubleSpringSim.en.MASS2);
    this.addControl(new mpl$lab$controls$SliderControl(a,.2,20.2,!0));
    a = c.getParameterNumber(mpl$sims$springs$DoubleSpringSim.en.DAMPING);
    this.addControl(new mpl$lab$controls$SliderControl(a,0,1,!1));
    
    a = c.getParameterNumber(mpl$sims$springs$DoubleSpringSim.en.STIFFNESS);
    this.addControl(new mpl$lab$controls$SliderControl(a,0,200,!1));

    c = new mpl$lab$controls$ButtonControl(mpl$sims$springs$DoubleSpringSim.i18n.REST_STATE,goog.bind(c.restState, c));
    this.addControl(c);
    this.makeEasyScript();
    this.addURLScriptButton()
};
$jscomp.inherits(mpl$sims$springs$DoubleSpringApp, mpl$sims$common$AbstractApp);
mpl$sims$springs$DoubleSpringApp.prototype.toString = function() {
    return mpl$lab$util$Util.ADVANCED ? "" : this.toStringShort().slice(0, -1) + ", block1: " + this.block1.toStringShort() + ", block2: " + this.block2.toStringShort() + ", spring1: " + this.spring1.toStringShort() + ", spring2: " + this.spring2.toStringShort() + ", spring3: " + this.spring3.toStringShort() + ", wall1: " + this.wall1.toStringShort() + ", wall2: " + this.wall2.toStringShort() + mpl$sims$common$AbstractApp.prototype.toString.call(this)
}
;
mpl$sims$springs$DoubleSpringApp.prototype.getClassName = function() {
    return "DoubleSpringApp"
}
;
mpl$sims$springs$DoubleSpringApp.prototype.defineNames = function(a) {
    mpl$sims$common$AbstractApp.prototype.defineNames.call(this, a);
    this.terminal.addRegex("wall1|wall2|block1|block2|spring1|spring2|spring3|protoWall|protoBlock|protoSpring", a + ".")
}
;
function module$contents$myphysicslab$sims$springs$DoubleSpringApp_makeDoubleSpringApp(a) {
    return new mpl$sims$springs$DoubleSpringApp(a)
}
goog.exportSymbol("makeDoubleSpringApp", module$contents$myphysicslab$sims$springs$DoubleSpringApp_makeDoubleSpringApp);
